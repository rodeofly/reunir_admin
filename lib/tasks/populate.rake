  ...
  namespace :db do  
    ...
    task :populate => :environment do  
      ...
      5.times do
        ...
        :terme_sa => Forgery(:basic).number(:at_least => 25, :at_most => 42),
        ...
        :facteur_declenchant => Forgery::Basic.boolean,
        ...
        :rang_dans_la_fratrie => Forgery(:basic).number(:at_least => 0, :at_most => 10),
        :fratrie_en_surpoids => Forgery(:basic).number(:at_least => 0, :at_most => 10),
        :habitant_du_foyer => Forgery(:basic).number(:at_least => 0, :at_most => 10),
